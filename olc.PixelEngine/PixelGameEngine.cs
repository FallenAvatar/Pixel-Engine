...
namespace olc {
	...
	public abstract class PixelGameEngine {
		...
		public ReturnCode Construct(uint screen_w, uint screen_h, uint pixel_w, uint pixel_h, bool fullscreen = false, bool vsync = false ) {
			if( !Renderer.ConstructWindow( screen_w, screen_h ) )
		...
		public void SetPixelMode( Pixel.Mode m ) { Renderer.PixelMode = m; }
		public Pixel.Mode GetPixelMode() => Renderer.PixelMode;
